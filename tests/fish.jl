...
# ╔═╡ 90ea7250-7119-484f-ba97-3d0ecbcd1a8f
using CairoMakie

# ╔═╡ 582bf8b3-f0d3-4659-a3c4-98f5f1b75f15
using Statistics

# ╔═╡ 9f8e1836-c60e-11ee-1934-f388c297cfea
...
# ╔═╡ 1399e33f-5805-4e08-a2ab-dc164059a441
school = [Fish() for _ in 1:10]

# ╔═╡ b9234595-994e-49f0-8092-c112bc264e10
function update!(fish::Fish)
	fish.x += fish.r * cos(fish.θ)
	fish.y += fish.r * sin(fish.θ)
	return fish
end

# ╔═╡ b2e74358-273e-42bc-b405-8891bdb3ebee
function xy(school::Vector{Fish})
	return [(fish.x, fish.y) for fish in school]
end

# ╔═╡ 370c30d5-9076-44f2-aece-ec2628f87e5a
map(update!, school)

# ╔═╡ f2f213b2-6268-44c1-ae07-91d9507c0e28
begin
	scatter(xy(school))
	map(update!, school)
	scatter!(xy(school))
...
manifest_format = "2.0"
project_hash = "d496f5c23a5a250442e3b24e814e87aceb2b4ac2"
