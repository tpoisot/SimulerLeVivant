#set page(
  ...
  header: align(
    right + horizon,
    text(font: "Libertinus Sans", fill: luma(40%), size: 8pt)[$author.prenom$ $author.nom$ - $author.matricule$],
  ),
  numbering: "1 de 1",
)
#set par(
...
#text(fill: luma(20), font: "Libertinus Sans", size: 20pt)[$titre$]
#linebreak()
#text(fill: luma(70), font: "Libertinus Sans", size: 15pt)[$author.prenom$ $author.nom$ - $author.matricule$]
